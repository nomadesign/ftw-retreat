      ...
      <div className="row">
        <div className="col-12">
          ...
          <p className="body-2">
            ...
            or make a purchase from forthewomenretreat.com (the “Site”).
          </p>
          <p className="subhead-1">Personal information we collect</p>
          <p className="body-2">
            We collect personal information you provide to us, like email address. We also collect certain anonymized
            data about your usage of the site.
          </p>
          ...
          <p className="body-2">
            ...
            complaint, please contact us by e-mail at contact@forthewomenretreat.com.
          </p>
        </div>
      </div>
    </div>
