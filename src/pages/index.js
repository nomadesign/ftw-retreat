          ...
          <div className="row">
            ...
            <div className="col-11">
              ...
              <section className="checkout-button">
                <a href="https://elpha.com" target="_blank" rel="noopener noreferrer" className="button">
                  Join Elpha
                </a>
                <div className="checkout-button-faq">Read more about our story below</div>
              </section>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-9">
              <p className="title-1">
                <strong>
                  FTW Retreat is joining forces with Leap to become an independent company with a new name: Elpha!
                </strong>{' '}
                It’s a private community for women to excel in tech.
              </p>
            </div>
          </div>
            ...
            <div className="col-8">
              <div className="description-history">
                <p className="subhead-2">
                  Seven months ago, I started FTW Retreat to create an offline experience where women leaders in tech
                  could connect, share experiences, and pool resources to help each other grow. It was something I
                  desired when I was working in tech, but never found, so I decided to build it. Last October, a group
                  of us ladies met in Québec for the first retreat and the experience proved the importance of seeking
                  and building such a community of connected minds.
                </p>
                <p className="subhead-2">
                  One of the things I love the most about building For the Women Retreat has been that I got to discover
                  many other like-minded communities aiming for this very mission, such as Leap by Cadran and Hustle
                  Crew by Abadesi.
                </p>
                <p className="subhead-2">
                  The more the three of us talked, the more obvious it was that we should work together, using our
                  complimentary skills to make our shared vision real -- building the most powerful network for women in
                  tech. Software is more scalable, at least at the beginning, than in-person experiences, so we decided
                  to lean into our strengths and focus on software first with the hope of introducing offline
                  experiences such as a retreat later.
                </p>
                <p className="subhead-2">
                  In the past few months, we’ve been tinkering at what this network for women in tech could look like,
                  using Leap as the foundation. If you identify with women, and work in tech (or hope to in the future),
                  you can join Elpha today. We want Elpha to be the go-to resource for women in tech to access industry
                  experts, learn from peers, and find answers to their most pressing personal and professional questions
                  and, of course, make lasting friendships, just like what you will get out of a FTW Retreat, but
                  online.
                </p>
                <p className="subhead-2">
                  Thank you for supporting FTW Retreat – Elpha has been co-founded as a result of this community, and
                  I’m beyond grateful for the feedback and advice you’ve given.
                </p>
                <p className="subhead-2">
                  Cheers,
                  <br />
                  ...
                  <br />
                  <br />
                  PS: Bloomberg wrote a nice piece on our launch, and you can read about it{' '}
                  <a
                    href="https://www.bloomberg.com/news/articles/2019-02-04/y-combinator-s-women-only-forum-is-becoming-its-own-business?srnd=technology-vp"
                    target="_blank"
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-6">
              <div className="testimonial-left testimonial-margin">
                <p className="body-2 ">
                  “It's not a retreat, it's an experience. Kuan took care of every little detail. Between the incredible
                  house, the delicious food, and the amazing women, this is the perfect way to unplug and find your
                  people.”
                </p>
                <div className="media">
            ...
            <div className="col-6">
              <div className="testimonial-right testimonial-margin">
                <p className="body-2">
                  “FTW Retreat was the perfect time and space to be creative (I shipped the first draft of my book!), to
                  revel in some stillness in nature, and to learn from other boss women.”
                </p>
                <div className="media">
          ...
          <div className="row">
            <div className="col-6">
              <div className="testimonial-left testimonial-margin">
                <p className="body-2 ">
                  “Thanks for crafting a perfect weekend of relaxation, great food and meaningful conversation - I left
                  feeling incredibly recharged and inspired.”
                </p>
                <div className="media">
