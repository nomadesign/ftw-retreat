      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-10">
            ...
            <p className="body-2">The retreat costs between $1,250 and $1,750 depending on your room choices (most of the accommodations are private rooms with queen-size beds). It includes 4-night accommodations, and nourishing meals every day. </p>
