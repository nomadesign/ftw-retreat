          ...
          <div className="col-10">
            ...
            <p className="body-2">
              <ul className="body-list">
                <li><strong>Ableism:</strong> Words like "crazy", "dumb", "insane" or "lame" are examples of ableist language, devaluating people who have physical or mental disabilities. Its appearance often stems not from any intentional desire to offend, but from our innate sense of what it means to be normal. These words can be avoided by using more fitting, clearer descriptions of what we want to communicate. To find out more about ableism and replacement terms please read <a href="https://www.autistichoya.com/p/ableist-words-and-terms-to-avoid.html">this guide</a>.</li>
                <li><strong>Sexism:</strong> Using gendered terms like "dude" or "guys" to address a mixed-gendered group of people contributes to furthering exclusion of underrepresented individuals. We strongly advise avoiding gendered pronouns as well as gendered terms. For more information please familiarise yourself with <a href="http://geekfeminism.wikia.com/wiki/Nonsexist_language">Geek Feminism wiki guide</a>.</li>
              </ul>
            </p>
            ...
            <p className="body-2">
              If someone makes you or anyone else feel unsafe or unwelcome, please make a report immediately either in person or via email at <a href="mailto:contact@forthewomenretreat.com">contact@forthewomenretreat.com</a>.
            </p>
            ...
            <p className="body-2">
              This Code of Conduct was based on resources provided by <a href="https://2018.xoxofest.com/conduct">XOXO Fest</a>, <a href="https://2018.jsconfau.com/code-of-conduct">JSConf AU</a> and <a href="https://www.djangoproject.com/conduct/">Django</a>. It is licensed under a <a href="https://creativecommons.org/licenses/by/4.0/">Creative Commons Attribution 4.0 International license</a>.
            </p>
